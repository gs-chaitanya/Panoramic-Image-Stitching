...
class Panaroma:
    ...
    # This method is used to draw lines on the panorama component images to show matching features
...
for i in range(no_of_images):
    images[i] = imutils.resize(images[i],height=600, width=600)
...
#tdisplay all the images that have been passed to be stitched - here I have chosen three photos from the internet
for i in range(no_of_images):
